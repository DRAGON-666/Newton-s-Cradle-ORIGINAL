...
function setup() {
	...
	rope2 =new Rope (bobObject2.body,roof.body,2,0)


	bobObject3 = new Bob (300,200); 

	rope3 =new Rope (bobObject3.body,roof.body,4,0)

	
	bobObject4 =new Bob  (350,200);

	rope4 =new Rope (bobObject4.body,roof.body,6,0)


	bobObject5 =new Bob  (400,200);

	rope5 =new Rope (bobObject5.body,roof.body,8,0)
